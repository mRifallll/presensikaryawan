...
$result = mysqli_query($con, "SELECT * FROM lokasi_presensi ORDER BY id DESC");
?>

<div class="page-body">
    <div class="container-xl">
        <a href="<?= base_url('admin/data_lokasi_presensi/tambah.php') ?>" class="btn btn-primary"><span class="text"><i class="fa-solid fa-circle-plus"></i></span>Tambah data</a>
        ...
        <table class="table table-bordered mt-3">
            ...
            <?php if (mysqli_num_rows($result) === 0) { ?>
                <tr>
                    <td colspan="6" align="center">Data kosong, silahkan tambahkan data baru</td>
                </tr>
            <?php } else { ?>
                <?php $no = 1;
