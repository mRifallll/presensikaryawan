...
if (empty($_GET['filter_bulan'])) {
    ...
    $result = mysqli_query($con, "SELECT presensi.*, pegawai.nama, pegawai.lokasi_presensi FROM presensi JOIN pegawai ON presensi.id_pegawai = pegawai.id WHERE DATE_FORMAT(tgl_masuk, '%Y-%m') = '$bulan_sekarang' ORDER BY tgl_masuk DESC");
} else {
    $filter_tahun_bulan = $_GET['filter_tahun'] . '-' . $_GET['filter_bulan'];
    $result = mysqli_query($con, "SELECT presensi.*, pegawai.nama, pegawai.lokasi_presensi FROM presensi JOIN pegawai ON presensi.id_pegawai = pegawai.id WHERE DATE_FORMAT(tgl_masuk, '%Y-%m') = '$filter_tahun_bulan' ORDER BY tgl_masuk DESC");
}
