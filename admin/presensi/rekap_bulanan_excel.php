...
$result = mysqli_query($con, "SELECT presensi.*, pegawai.nama, pegawai.lokasi_presensi, pegawai.nip FROM presensi JOIN pegawai ON presensi.id_pegawai = pegawai.id WHERE DATE_FORMAT(tgl_masuk, '%Y-%m') = '$filter_tahun_bulan' ORDER BY tgl_masuk DESC");
