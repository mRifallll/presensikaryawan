...
if (isset($_POST['update'])) {
    ...
    if (!empty($pesan_kesalahan)) {
        ...
        $result = mysqli_query($con, "UPDATE ketidakhadiran SET keterangan='$keterangan', deskripsi = '$deskripsi', tanggal = '$tanggal', file = '$nama_file' WHERE id = $id");

        $_SESSION['berhasil'] = 'Data Diupdate disimpan';
