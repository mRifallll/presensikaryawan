...
if (isset($_POST['login'])) {
    ...
    $result = mysqli_query($con, "SELECT * from users join pegawai ON users.id_pegawai = pegawai.id WHERE username = '$username'");
...
<head>
    ...
    <title>Login Presensi Sejahtera Abadi</title>
    <!-- CSS files -->
                ...
                <div class="col-lg">
                    <div class="container-tight">
                        <div class="text-center mb-4">
                            <a href="." class="navbar-brand navbar-brand-autodark"><img src="<?= base_url('assets/img/sagrup.jpeg') ?>" height="50" alt=""></a>
                        </div>
                        <?php
                        if (isset($_GET['pesan'])) {
                            ...
                            <div class="card-body">
                                ...
                                <form action="" method="POST" autocomplete="off" novalidate>
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" autofocus name="username" autocomplete="off">
                                    </div>
                                    <div class="mb-2">
